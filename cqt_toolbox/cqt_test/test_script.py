...
signal2, sr2 = librosa.core.load('cqt_toolbox/cqt_test/audio_files/original/chirps.wav')
signal3, sr3 = librosa.core.load('cqt_toolbox/cqt_test/audio_files/original/trombone.wav')
...
librosa.output.write_wav('cqt_toolbox/cqt_test/audio_files/reconstructed/re_synth.wav',signal1,samp_rate)
librosa.output.write_wav('cqt_toolbox/cqt_test/audio_files/reconstructed/re_chirps.wav',signal2,sr2)
librosa.output.write_wav('cqt_toolbox/cqt_test/audio_files/reconstructed/re_trombone.wav',signal3,sr3)
